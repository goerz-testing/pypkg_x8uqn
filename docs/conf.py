...
def run_apidoc(app):
    ...
    better_apidoc.main(
        [
            ...
            '-o',
            str(DOCS / 'API'),
            os.path.join(DOCS / '..' / 'src' / 'pypkg_x8uqn'),
        ]
    )
...
version = pypkg_x8uqn.__version__
release = version
git_tag = "v%s" % version
...
extlinks = {
    'issue': ('https://github.com/goerz-forks/pypkg_x8uqn/issues/%s', '#'),
    'pr': ('https://github.com/goerz-forks/pypkg_x8uqn/pull/%s', 'PR #'),
}
